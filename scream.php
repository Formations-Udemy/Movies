...
<body>
    <div class="container-fluid">
        <h1 style="text-align: center;">Scream</h1>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/scream.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scream.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scream.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scream.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                ...
                <strong>Stars:  Neve Campbell, Courteney Cox, David Arquette</strong>
            </div>
        </div>
    </div>
