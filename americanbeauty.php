...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/americanbeuaty.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/americanbeuaty.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/americanbeuaty.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/americanbeuaty.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                A sexually frustrated suburban father has a mid-life crisis after becoming infatuated with his daughter's best friend. <br>
                <strong>Stars: Kevin Spacey, Annette Bening, Thora Birch</strong>
            </div>
        </div>
    </div>
