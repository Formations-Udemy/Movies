...
<body>
    <div class="container-fluid">
        <h1 style="text-align: center;">Requiem for a dream</h1>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/requiem-for.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/requiem-for.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/requiem-for.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/requiem-for.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                The drug-induced utopias of four Coney Island people are shattered when their addictions run deep. <br>
                <strong>Stars: Ellen Burstyn, Jared Leto, Jennifer Connelly</strong>
            </div>
        </div>
    </div>
