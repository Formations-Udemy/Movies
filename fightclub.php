...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/flightclub.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/flightclub.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/flightclub.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/flightclub.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                An insomniac office worker and a devil-may-care soapmaker form an underground fight club that evolves into something much, much more. <br>
                <strong>Stars: Brad Pitt, Edward Norton, Meat Loaf</strong>
            </div>
        </div>
    </div>
