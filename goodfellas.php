...
<body>
    <div class="container-fluid">
        <h1 style="text-align: center;">Goodfellas</h1>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/goodfellas.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/goodfellas.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/goodfellas.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/goodfellas.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                The story of Henry Hill and his life in the mob, covering his relationship with his wife Karen Hill and his mob partners Jimmy Conway and Tommy DeVito in the Italian-American crime syndicate. <br>
                <strong>Stars: Robert De Niro, Ray Liotta, Joe Pesci</strong>
            </div>
        </div>
    </div>
