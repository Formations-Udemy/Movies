...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/scarface.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scarface.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scarface.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/scarface.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                In 1980 Miami, a determined Cuban immigrant takes over a drug cartel and succumbs to greed. <br>
                <strong>Stars: Al Pacino, Michelle Pfeiffer, Steven Bauer</strong>
            </div>
        </div>
    </div>
