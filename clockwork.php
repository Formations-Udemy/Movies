...
<body>
    <div class="container-fluid">
        <h1 style="text-align: center;">Clockwork Orange</h1>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <img class="img-fluid" src="public/filmsforsite/clockwork.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/clockwork.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/clockwork.jpg" alt="" style="max-width: 100%;">
                <img class="img-fluid" src="public/filmsforsite/clockwork.jpg" alt="" style="max-width: 100%;">
            </div>
            <div class="col">
                In the future, a sadistic gang leader is imprisoned and volunteers for a conduct-aversion experiment, but it doesn't go as planned. <br>
                <strong>Stars: Malcolm McDowell, Patrick Magee, Michael Bates</strong>
            </div>
        </div>
    </div>
